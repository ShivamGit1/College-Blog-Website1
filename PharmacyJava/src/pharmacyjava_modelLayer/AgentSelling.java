...
import pharmacyjava.ServiceLayer.AgentSellin_ServiceLayer;
import pharmacyjava.ServiceLayer.Sellin_ServiceLayer;

public class AgentSelling extends javax.swing.JFrame {

    /**
     * Creates new form AgentSelling
     */
    public AgentSelling() {
        initComponents();
         SelectMed();
   ...
   int sumTotal=0;
    ...
    public int Update()
    {
        ...
        AgentSellin_ServiceLayer sa=new AgentSellin_ServiceLayer();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgentSelling.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
